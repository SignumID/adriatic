...
alertText:"* Datum raniji od "},future:{regex:"none",alertText:"* Datum nakon "},maxCheckbox:{regex:"none",alertText:"* Maksimalno ",alertText2:" dozvoljenih opcija"},minCheckbox:{regex:"none",alertText:"* Molimo odaberite ",alertText2:" opcija"},equals:{regex:"none",alertText:"* Polja se ne podudaraju"},creditCard:{regex:"none",alertText:"* Neispravan broj kreditne kartice"},phone:{regex:/^([\+][0-9]{1,3}([\/\.\-])?)?([\(][0-9]{1,6}[\)])?([0-9 \.\-]{1,32})(([A-Za-z \:]{1,11})?[0-9]{1,4}?)$/,alertText:"* Pogre\u0161an unos telefonskog broja"},
...
alertText2:"O\u010dekivani format: ",alertText3:"mm/dd/gggg hh:mm:ss ili ",alertText4:"gggg-mm-dd hh:mm:ss "},mpcRequired:{regex:/^[0-9]{14}$/,alertText:"* Neto\u010dan broj MultiPlusCard kartice."},mpcPromoKodRequired:{regex:/^ZABA(?:[0-9A-Z]){7}$/,alertText:"*Va\u0161 k\u00f4d je neispravan"},suglasnostPromoKodRequired:{regex:/^ZB(?:[0-9A-Z]){9}$/,alertText:"*Va\u0161 k\u00f4d je neispravan"}}}};a.validationEngineLanguage.newLang()})(jQuery);